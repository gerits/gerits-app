...
<projects class="flex flex-col">
    ...
    {#if error === "" && repositories.length === 0}
        <div>
            <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-green-dark" viewBox="0 0 100 101" fill="none"
    ...
    {#if error !== ""}
        <div>
            Could not load the projects. Refresh the page to try again.
        </div>
    {/if}
    <div>
